...
<script>
    $(document).ready(function () {
      // Toggle the dropdown when the select box is clicked
      ...
      function updateSelectedOptions() {
        ...
        // Update the selected options in the placeholder
        if (selectedOptions.length > 0) {
          $(".multiselect-select").text(selectedOptions.join(", "));
        } else {
          $(".multiselect-select").text("Select options");
        }

        $("#selected-options-list").text(selectedOptions.join(", "));
      }
    });
  </script>
@endsection
